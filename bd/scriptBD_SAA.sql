...
create table `mydb`.`Contrato` (
    ...
    `fechaFinal` datetime,
    `númeroConcurso` varchar(10),
    `suplencia` bit,
    `porqueContratacion` varchar(40),
    `quienNombro` varchar(50),
    `puestoQuienNombro` varchar(15),
    `porcentajeTotalContratacion` int,
    `porcentajeLiberado` int,
